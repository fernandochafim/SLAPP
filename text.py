...
def get_rotation(rotation):
    """ Pietro Terna's correction (pietro.terna@unito.it)
    ...
    *rotation* may be 'horizontal', 'vertical', or a numeric value in degrees.
    ...
    """
    # new
    if rotation==None: angle=0
    elif str(rotation)=='horizontal':angle=0.
    elif str(rotation)=='vertical':angle=90.
    else: angle=float(rotation)
