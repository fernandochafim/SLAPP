...
Here you have SLAPP **v.1.6.1 build 201611017** (in the [SLAPP repository](http://terna.to.it/slapp_dep/) you have related material and very old versions; more recent ones are here in the Git).

We have here also a [**Reference Handbook**](https://github.com/terna/SLAPP/blob/v.1.6.1/SLAPP_Reference_Handbook.pdf) (it is still a draft and has to be improved).
